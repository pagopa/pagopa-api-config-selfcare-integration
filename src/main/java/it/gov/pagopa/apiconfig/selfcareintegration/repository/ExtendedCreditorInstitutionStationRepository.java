...
public interface ExtendedCreditorInstitutionStationRepository extends PaStazionePaRepository {
  ...
  @Query(value = "SELECT DISTINCT p FROM PaStazionePa p WHERE (p.fkPa = :fkPa)")
  Page<PaStazionePa> findAllByFilter(@Param("fkPa") Long creditorInstitutionId, Pageable pageable);
}
